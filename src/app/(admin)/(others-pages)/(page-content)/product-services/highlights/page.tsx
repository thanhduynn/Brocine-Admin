...
import { FIREBASE_BROSCINE, FIREBASE_HIGHLIGHTS, FIREBASE_SERVICES_COLL } from "@/constants/firebase";
...
export default function ProductServiceHighlights() {
  const {highlights, setServiceStore, fAddHighlight, modifyHighlights} = useServiceStore();
  ...
  const fetchData = async () => {
    const highlightsRef = collection(database, FIREBASE_BROSCINE, FIREBASE_SERVICES_COLL, FIREBASE_HIGHLIGHTS);
    ...
    setServiceStore('highlights', highlightsData);
  };
    ...
    <div>
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        <div className="space-y-6">
          <ImageGrid images={highlights} collectionName={FIREBASE_SERVICES_COLL} modifyHighlight={modifyHighlights}/>
