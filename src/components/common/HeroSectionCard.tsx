          ...
          <form className="flex flex-col">
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div>
                  <Label>Title</Label>
                  <Input name="title" type="text" onChange={handleChangeInput} value={content.title}/>
                </div>

                <div>
                  <Label>Subtitle</Label>
                  <Input name="subtitle" type="text" onChange={handleChangeInput} value={content.subtitle}/>
                </div>
